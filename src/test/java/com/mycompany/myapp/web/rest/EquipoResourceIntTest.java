...
public class EquipoResourceIntTest {
    ...
    public void initTest() {
        ...
        equipo.setFecha_fundacion(DEFAULT_FECHA_FUNDACION);
    ...
    public void createEquipo() throws Exception {
        ...
        assertThat(testEquipo.getFecha_fundacion()).isEqualTo(DEFAULT_FECHA_FUNDACION);
    ...
    public void getAllEquipos() throws Exception {
        ...
        restEquipoMockMvc.perform(get("/api/equipos"))
                ...
                .andExpect(jsonPath("$.[*].fecha_fundacion").value(hasItem(DEFAULT_FECHA_FUNDACION.toString())))
    ...
    public void getEquipo() throws Exception {
        ...
        restEquipoMockMvc.perform(get("/api/equipos/{id}", equipo.getId()))
            ...
            .andExpect(jsonPath("$.fecha_fundacion").value(DEFAULT_FECHA_FUNDACION.toString()))
    ...
    public void updateEquipo() throws Exception {
        ...
        equipo.setFecha_fundacion(UPDATED_FECHA_FUNDACION);
        ...
        assertThat(testEquipo.getFecha_fundacion()).isEqualTo(UPDATED_FECHA_FUNDACION);
